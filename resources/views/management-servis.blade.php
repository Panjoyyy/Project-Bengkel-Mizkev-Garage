            ...
            <tbody>
                ...
                <tr data-aos="fade-up" data-aos-delay="{{ $loop->iteration * 50 }}">
                    ...
                    <td style="color: #6c757d; font-size: 0.9rem;">
                        <i class="fas fa-calendar-alt me-2" style="color: #3b82f6;"></i>{{ $item->tanggal_servis }}
                    </td>
                    <td>
                        <div style="font-weight: 600; color: #1a2332;">{{ $item->motor->merk_motor ?? '-' }}</div>
                        <div style="font-size: 0.85rem; color: #6c757d;">{{ $item->motor->no_plat_motor ?? '-' }}</div>
                    </td>
                    <td style="color: #1a2332; font-weight: 500;">{{ $item->mechanic->mechanic_name ?? '-' }}</td>
                    <td style="color: #6c757d;">{{ $item->staff->nama_staff ?? '-' }}</td>
                    <td style="color: #6c757d; font-size: 0.9rem; max-width: 200px;">{{ Str::limit($item->keluhan, 50) }}</td>
                ...
                <tr>
                    <td colspan="8" style="text-align: center; padding: 60px 20px;">
                        <i class="fas fa-wrench" style="font-size: 4rem; color: #1a2332; margin-bottom: 20px;"></i>
                        <p style="color: #6c757d; font-size: 1.1rem; margin: 0;">Tidak ada data servis ditemukan</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
