...
<div style="background: white; min-height: calc(100vh - 60px); padding: 30px;">
    ...
    <div class="mb-4" data-aos="fade-down">
        <h2 style="font-size: 1.8rem; font-weight: 700; color: #1a2332; margin-bottom: 5px;">
            <i class="fas fa-plus-circle" style="color: #10b981; margin-right: 10px;"></i>Tambah Sparepart
        </h2>
        <p style="color: #6c757d; margin: 0; font-size: 0.95rem;">Masukkan data sparepart baru</p>
    </div>
            ...
            <form action="{{ route('spareparts.store') }}" method="POST" id="sparepartForm">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" 
                           ...
                           placeholder="Contoh: Oli Mesin Castrol 10W-40"
                           required
                           minlength="3"
                           maxlength="100">
                ...
                <div class="mb-4">
                    <label for="stok_sparepart" class="form-label" style="font-weight: 600; color: #1a2332; margin-bottom: 8px;">
                        <i class="fas fa-boxes me-2" style="color: #f59e0b;"></i>Stok <span class="text-danger">*</span>
                    </label>
                    ...
                    <small class="text-muted">Jumlah stok sparepart (0 - 10.000 pcs)</small>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <small class="text-muted">Minimal Rp 100, maksimal Rp 10.000.000</small>
                </div>
