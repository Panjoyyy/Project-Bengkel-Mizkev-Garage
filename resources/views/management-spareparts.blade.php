...
<div class="row">
    <div class="col-12 d-flex justify-content-between align-items-center">
        ...
        <form action="{{ route('spareparts.index') }}" method="GET" class="d-flex justify-content-end mb-3" style="gap: 10px;">
        ...
        <a href="{{ route('spareparts.create-form') }}" class="btn btn-success">+ Tambah Sparepart</a>
    </div>
</div>
                        ...
                        <tbody>
                            @foreach ($spareparts as $sparepart)
                                <tr style="vertical-align: middle">
                                    ...
                                    <td>
                                        {{-- Tombol Edit --}}
                                        <a href="{{ route('spareparts.edit-form', $sparepart->id_sparepart) }}" class="btn btn-primary btn-sm">
                                        ...
                                        <div class="modal fade" id="{{ 'delete' . $sparepart->id_sparepart }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            Apakah anda yakin menghapus sparepart
